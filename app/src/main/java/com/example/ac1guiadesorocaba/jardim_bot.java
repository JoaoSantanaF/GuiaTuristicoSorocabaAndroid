...
public class jardim_bot extends MainActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pg_jardimbotanico);
        ...
        btn_vermapa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String endereco = "R. Miguel Montoro Lozano, 340 - Jardim Iguatemi, Sorocaba - SP";
        ...
        btn_abrirsite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlDoSite = "https://turismo.sorocaba.sp.gov.br/visite/jardim-botanico-irmaos-vilas-boas/";
        ...
        btn_tel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String numeroTelefone = "(15) 3235-1130"; // Substitua pelo número real
