...
public class catedral extends MainActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pg_catedral);
        ...
        btn_vermapa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String endereco = "Praça Cel. Fernando Prestes, S/Nº - Centro, Sorocaba - SP";
        ...
        btn_abrirsite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlDoSite = "http://www.catedraldesorocaba.org.br/";
        ...
        btn_tel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String numeroTelefone = "(15) 3233-3233"; // Substitua pelo número real
